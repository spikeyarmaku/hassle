...
const uint8_t rule_s_f[] = {
    ...
    OP_CONNECT, VAR(4), 0, VAR(1),
    // agent_F->ports[1] = name_b;
    OP_CONNECT, VAR(4), 1, VAR(3),
...
const uint8_t rule_f_f[] = {
    ...
    OP_CONNECT, VAR(3), 0, VAR(5),
    // agent_F_2->ports[1] = name_b;
    OP_CONNECT, VAR(3), 1, VAR(2),
    ...
    OP_CONNECT, VAR(7), 0, VAR(4),
    // agent_F_3->ports[1] = name_a;
    OP_CONNECT, VAR(7), 1, VAR(1),
...
const uint8_t rule_f_app[] = {
    ...
    OP_CONNECT, VAR(0), 1, L(1),
    // agent_app1->ports[2] = agent1->ports[0];
    OP_CONNECT, VAR(0), 2, R(0),
