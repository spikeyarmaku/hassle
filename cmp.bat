@echo off
@REM set "files=src\main.c src\memory.c src\global.c src\parse\expr.c src\parse\parse.c src\rational\alnat.c src\rational\rational.c src\execute\env.c src\execute\eval.c src\execute\builtin.c src\execute\term.c"
